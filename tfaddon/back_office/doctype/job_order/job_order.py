...
class JobOrder(SellingController):
	def __init__(self, arg1, arg2=None):
		super(JobOrder, self).__init__(arg1, arg2)
		self.status_updater = [{
	...
	def validate_warehouse(self):
		super(JobOrder, self).validate_warehouse()
	...
	def validate_with_previous_doc(self):
		super(JobOrder, self).validate_with_previous_doc({
			"Sales Order": {
...
@frappe.whitelist()
def update_job_order_status(docname, status):
	dn = frappe.get_doc("Job Order", docname)
