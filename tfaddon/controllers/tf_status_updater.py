...
status_map = {
	"Sampling Request": [
		["Draft", None],
		["Assigned", "eval:self.docstatus==1"],
		["Closed", "has_disposed_details"],
		["Cancelled", "eval:self.docstatus==2"],
	],
	"Samples": [
		["Draft", None],
		["Collected", "eval:self.docstatus==1"],
		["Dispatched", "has_dispatch_details"],
		["Received", "has_receipt_details"],
		["Testing", "has_open_job_order"],
		["Completed", "has_completed_job_order"],
		["Disposed", "has_disposed_details"],
		["Cancelled", "eval:self.docstatus==2"],
	],
	"Lead": [
...
class TFStatusUpdater(Document):
	"""
